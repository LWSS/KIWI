...
{                                       // ...
    ...
    uint opcodeLookupMaxLen;    // ...
    uint opcodeLookupLen;       // ...
    SourceLookup *sourcePosLookup;      // ...
    uint sourcePosLookupMaxLen; // ...
    uint sourcePosLookupLen;    // ...
    uint sourceBufferLookupMaxLen; // ...
    const uint8_t *currentCodePos; // ...
    uint currentSourcePosCount; // ...
    SaveSourceBufferInfo *saveSourceBufferLookup; // ...
    uint saveSourceBufferLookupLen; // ...
