...
// Miles' file-callback bridge (see MSS_File*Callback in snd_mss.cpp).
...
// KISAK (miles9): HSAMPLE comes from mss.h.
...
{                                       // ...
    ...
    MssEqInfo eq[2];                    // ...
    // KISAK: `uint eqFilter` (HPROVIDER of the removed "3 Band Parm Eq" .flt) lived here
#ifndef KISAK_XBOX
	float eqLerp;
#endif
