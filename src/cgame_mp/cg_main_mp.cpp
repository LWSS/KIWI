...
void __cdecl CG_Init(int localClientNum, int serverMessageNum, int serverCommandSequence, int clientNum)
{
    ...
    cgMedia.nightVisionOverlay = Material_RegisterHandle("nightvision_overlay_goggles", IMAGE_TRACK_HUD);
    cgMedia.hudIconNVG = Material_RegisterHandle("hud_icon_nvg", IMAGE_TRACK_HUD);
    cgMedia.hudDpadArrow = Material_RegisterHandle("hud_dpad_arrow", IMAGE_TRACK_HUD);
    cgMedia.ammoCounterBullet = Material_RegisterHandle("ammo_counter_bullet", IMAGE_TRACK_HUD);
    cgMedia.ammoCounterBeltBullet = Material_RegisterHandle("ammo_counter_beltbullet", IMAGE_TRACK_HUD);
    cgMedia.ammoCounterRifleBullet = Material_RegisterHandle("ammo_counter_riflebullet", IMAGE_TRACK_HUD);
    cgMedia.ammoCounterRocket = Material_RegisterHandle("ammo_counter_rocket", IMAGE_TRACK_HUD);
    cgMedia.ammoCounterShotgunShell = Material_RegisterHandle("ammo_counter_shotgunshell", IMAGE_TRACK_HUD);
    cgMedia.textDecodeCharacters = Material_RegisterHandle("decode_characters", IMAGE_TRACK_HUD);
    cgMedia.textDecodeCharactersGlow = Material_RegisterHandle("decode_characters_glow", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_soundcpu", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_snapshotents", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_maxeffects", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_models", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_file", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_fps", IMAGE_TRACK_HUD);
    Material_RegisterHandle("code_warning_serverfps", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killicondied", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconcrush", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconfalling", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconsuicide", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconheadshot", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconmelee", IMAGE_TRACK_HUD);
...
void __cdecl CG_RegisterGraphics(int localClientNum, const char *mapname)
{
    ...
    cgMedia.connectionMaterial = Material_RegisterHandle("headicondisconnected", IMAGE_TRACK_HUD);
    cgMedia.youInKillCamMaterial = Material_RegisterHandle("headiconyouinkillcam", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconmelee", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconsuicide", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconfalling", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killiconcrush", IMAGE_TRACK_HUD);
    Material_RegisterHandle("killicondied", IMAGE_TRACK_HUD);
    cgMedia.tracerMaterial = Material_RegisterHandle("gfx_tracer", IMAGE_TRACK_FX);
    cgMedia.laserMaterial = Material_RegisterHandle("gfx_laser", IMAGE_TRACK_FX);
    cgMedia.laserLightMaterial = Material_RegisterHandle("gfx_laser_light", IMAGE_TRACK_FX);
    cgMedia.hintMaterials[HINT_ACTIVATE] = Material_RegisterHandle("hint_usable", IMAGE_TRACK_HUD);
    cgMedia.hintMaterials[HINT_HEALTH] = Material_RegisterHandle("hint_health", IMAGE_TRACK_HUD);
    cgMedia.hintMaterials[HINT_FRIENDLY] = Material_RegisterHandle("hint_friendly", IMAGE_TRACK_HUD);
    cgMedia.stanceMaterials[0] = Material_RegisterHandle("stance_stand", IMAGE_TRACK_HUD);
    cgMedia.stanceMaterials[1] = Material_RegisterHandle("stance_crouch", IMAGE_TRACK_HUD);
    cgMedia.stanceMaterials[2] = Material_RegisterHandle("stance_prone", IMAGE_TRACK_HUD);
    cgMedia.stanceMaterials[3] = Material_RegisterHandle("stance_flash", IMAGE_TRACK_HUD);
    cgMedia.objectiveMaterials[0] = Material_RegisterHandle("objective", IMAGE_TRACK_HUD);
    cgMedia.friendMaterials[0] = Material_RegisterHandle("compassping_friendly_mp", IMAGE_TRACK_HUD);
    cgMedia.friendMaterials[1] = Material_RegisterHandle("objective_friendly_chat", IMAGE_TRACK_HUD);
    cgMedia.damageMaterial = Material_RegisterHandle("hit_direction", IMAGE_TRACK_HUD);
    cgMedia.mantleHint = Material_RegisterHandle("hint_mantle", IMAGE_TRACK_HUD);
    cgMedia.compassping_friendlyfiring = Material_RegisterHandle("compassping_friendlyfiring_mp", IMAGE_TRACK_HUD);
    cgMedia.compassping_friendlyyelling = Material_RegisterHandle("compassping_friendlyyelling_mp", IMAGE_TRACK_HUD);
    cgMedia.compassping_enemy = Material_RegisterHandle("compassping_enemy", IMAGE_TRACK_HUD);
    cgMedia.compassping_enemyfiring = Material_RegisterHandle("compassping_enemyfiring", IMAGE_TRACK_HUD);
    cgMedia.compassping_enemyyelling = Material_RegisterHandle("compassping_enemyyelling", IMAGE_TRACK_HUD);
    ...
    cgMedia.compass_radarline = Material_RegisterHandle("compass_radarline", IMAGE_TRACK_HUD);
    cgMedia.compass_helicopter_enemy = Material_RegisterHandle("compass_objpoint_helicopter_busy", IMAGE_TRACK_HUD);
    cgMedia.compass_helicopter_friendly = Material_RegisterHandle("compass_objpoint_helicopter_friendly", IMAGE_TRACK_HUD);
    cgMedia.compass_plane_enemy = Material_RegisterHandle("compass_objpoint_airstrike_busy", IMAGE_TRACK_HUD);
    cgMedia.compass_plane_friendly = Material_RegisterHandle("compass_objpoint_airstrike_friendly", IMAGE_TRACK_HUD);
    cgMedia.grenadeIconFrag = Material_RegisterHandle("hud_grenadeicon", IMAGE_TRACK_HUD);
    cgMedia.grenadeIconFlash = Material_RegisterHandle("hud_flashbangicon", IMAGE_TRACK_HUD);
    cgMedia.grenadeIconThrowBack = Material_RegisterHandle("hud_grenadethrowback", IMAGE_TRACK_HUD);
    cgMedia.grenadePointer = Material_RegisterHandle("hud_grenadepointer", IMAGE_TRACK_HUD);
...
DObj_s *__cdecl CG_GetDObj(uint handle, int localClientNum)
{
