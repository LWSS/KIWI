            ...
            else
            {
                ...
                else
                {
                    ...
                    if (cleanValue[0])
                    {
                        ...
                        {
                            Com_Printf(CON_CHANNEL_SYSTEM, "Info buffer length exceeded, not including key/value pair in response.");
                        }
                    }
                }
            }
...
void __cdecl Info_SetValueForKey_Big(char *s, const char *key, const char *value)
{
    ...
    {
        Com_Printf(CON_CHANNEL_SYSTEM, "Info_SetValueForKey_Big: oversize infostring");
        return;
    }
    ...
    while (v21 < iNumFields)
    {
        ...
        if (*src)
        {
            ...
            else
            {
                ...
                case CSPFT_INT:
                    v7 = atoi(src);
                    *(uint *)&pStruct[v20->iOffset] = v7;
                    break;
                case CSPFT_QBOOLEAN:
                    v8 = atoi(src);
                    *(uint *)&pStruct[v20->iOffset] = v8 != 0;
                    break;
                case CSPFT_FLOAT:
                    v16 = atof(src);
                ...
                case CSPFT_MILLISECONDS:
                    v15 = atof(src);
                    *(uint *)&pStruct[v20->iOffset] = (int)(v15 * 1000.0);
                    break;
                case CSPFT_FX:
#ifdef KISAK_MP
...
uint __cdecl LongNoSwap(uint color)
{
    return color;
}
