...
void __cdecl FFT(complex_s *data_inout, uint log2_count, int *bitSwap, complex_s *trigTable)
{
    int v4; // eax
    float imag; // ecx
    float* v6; // edi
    ...
    float* v27; // ecx
    float* v28; // eax
    uint v29; // [esp+44h] [ebp-10C8h]
    uint j; // [esp+48h] [ebp-10C4h]
    float v31[512]; // [esp+4Ch] [ebp-10C0h] BYREF
    uint v32; // [esp+84Ch] [ebp-8C0h]
    uint v33; // [esp+850h] [ebp-8BCh]
