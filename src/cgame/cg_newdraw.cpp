...
void __cdecl CG_AntiBurnInHUD_RegisterDvars()
{
    ...
    hud_fade_ammodisplay = Dvar_RegisterFloat("hud_fade_ammodisplay", 8.0f, 0.0f, 30.0f, DVAR_ARCHIVE, "The time for the ammo display to fade in seconds");
    ...
    hud_fade_compass = Dvar_RegisterFloat("hud_fade_compass", 8.0f, 0.0f, 30.0f, DVAR_ARCHIVE, "The time for the compass to fade in seconds");
    ...
    hud_fade_offhand = Dvar_RegisterFloat("hud_fade_offhand", 8.0f, 0.0f, 30.0f, DVAR_ARCHIVE, "The time for the offhand weapons to fade in seconds");
    ...
    hud_healthOverlay_pulseStart = Dvar_RegisterFloat("hud_healthOverlay_pulseStart", 0.35f, 0.0f, 1.0f, DVAR_NOFLAG, "The percentage of full health at which the low-health warning overlay begins flashing");
    hud_healthOverlay_phaseOne_pulseDuration = Dvar_RegisterInt("hud_healthOverlay_phaseOne_pulseDuration", 150, (DvarLimits)0x3E800000000LL, DVAR_NOFLAG, "Time in milliseconds to ramp up to the first alpha value (the peak of the pulse)");
    hud_healthOverlay_phaseTwo_toAlphaMultiplier = Dvar_RegisterFloat("hud_healthOverlay_phaseTwo_toAlphaMultiplier", 0.7f, 0.0f, 1.0f, DVAR_NOFLAG, "Alpha multiplier for the second health overlay phase (percentage of the pulse peak)");
    hud_healthOverlay_phaseTwo_pulseDuration = Dvar_RegisterInt("hud_healthOverlay_phaseTwo_pulseDuration", 320, (DvarLimits)0x3E800000000LL, DVAR_NOFLAG, "Time in milliseconds to fade the alpha to hud_healthOverlay_phaseTwo_toAlphaMultiplier");
    hud_healthOverlay_phaseThree_toAlphaMultiplier = Dvar_RegisterFloat("hud_healthOverlay_phaseThree_toAlphaMultiplier", 0.6f, 0.0f, 1.0f, DVAR_NOFLAG, "Alpha multiplier for the third health overlay phase (percentage of the pulse peak)");
    hud_healthOverlay_phaseThree_pulseDuration = Dvar_RegisterInt("hud_healthOverlay_phaseThree_pulseDuration", 400, (DvarLimits)0x3E800000000LL, DVAR_NOFLAG, "Time in milliseconds to fade the alpha to hud_healthOverlay_phaseThree_" "toAlphaMultiplier");
    hud_healthOverlay_phaseEnd_toAlpha = Dvar_RegisterFloat("hud_healthOverlay_phaseEnd_toAlpha", 0.0f, 0.0f, 1.0f, DVAR_NOFLAG, "Alpha multiplier to fade to before turning off the overlay (percentage of the pulse peak)");
    hud_healthOverlay_phaseEnd_pulseDuration = Dvar_RegisterInt("hud_healthOverlay_phaseEnd_pulseDuration", 700, (DvarLimits)0x3E800000000LL, DVAR_NOFLAG, "Time in milliseconds to fade out the health overlay after it is done flashing");
    ...
    float *color)
{
    ...
    if ((cgameGlob->predictedPlayerState.eFlags & 0x20000) == 0 || (cgameGlob->predictedPlayerState.eFlags & 0x80000) != 0)
    {
        ...
        if (fadeAlpha != 0.0f)
        {
            int sprintLeft = PM_GetSprintLeft(&cgameGlob->predictedPlayerState, cgameGlob->time);
            int maxSprint = BG_GetMaxSprintTime(&cgameGlob->predictedPlayerState);
