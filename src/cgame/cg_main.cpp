...
void __cdecl CG_RegisterGraphics(int localClientNum, const char *mapname)
{
    ...
    cgMedia.objectiveMaterials[1] = Material_RegisterHandle("objective_ring", IMAGE_TRACK_HUD);
    ...
    cgMedia.checkbox_active = Material_RegisterHandle("hud_checkbox_active", IMAGE_TRACK_HUD);
    cgMedia.checkbox_current = Material_RegisterHandle("hud_checkbox_current", IMAGE_TRACK_HUD);
    cgMedia.checkbox_done = Material_RegisterHandle("hud_checkbox_done", IMAGE_TRACK_HUD);
    cgMedia.checkbox_fail = Material_RegisterHandle("hud_checkbox_fail", IMAGE_TRACK_HUD);
    cgMedia.compassping_friendlyfiring = Material_RegisterHandle("compassping_friendlyfiring", IMAGE_TRACK_HUD);
    cgMedia.compassping_friendlyyelling = Material_RegisterHandle("compassping_friendlyyelling", IMAGE_TRACK_HUD);
    ...
    cgMedia.vehBouncingDiamondReticle = Material_RegisterHandle("veh_hud_diamond", IMAGE_TRACK_HUD);
...
void __cdecl CG_Init(int localClientNum, int savegame)
{
    ...
    cgMedia.compassFovMaterial = Material_RegisterHandle("compass_fov", IMAGE_TRACK_HUD);
