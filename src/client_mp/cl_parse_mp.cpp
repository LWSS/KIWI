...
void __cdecl CL_ParseServerMessage(int localClientNum, msg_t *msg)
{
    ...
    if ((uint)(msg->cursize - msg->readcount) > sizeof(msgCompressed_buf))
...
{
    uint v5; // [esp+0h] [ebp-164h]
    uint v6; // [esp+10h] [ebp-154h]
    uint v7; // [esp+20h] [ebp-144h]
    ...
    uint configStringIndex; // [esp+4Ch] [ebp-118h]
    uint newnum; // [esp+50h] [ebp-114h]
