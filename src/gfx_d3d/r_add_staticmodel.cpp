...
{
    const char *v9; // eax
    uint baseIndex; // [esp+30h] [ebp-28h]
    uint16_t *preTessIndices; // [esp+38h] [ebp-20h]
    uint listIter; // [esp+40h] [ebp-18h]
    uint firstIndex; // [esp+44h] [ebp-14h]
    uint16_t *dstIndices; // [esp+48h] [ebp-10h]
    uint preTessSurf; // [esp+4Ch] [ebp-Ch]
    const XSurface *xsurf; // [esp+50h] [ebp-8h]
    uint surfIndexCount; // [esp+54h] [ebp-4h]
...
GfxStaticModelId __cdecl R_GetStaticModelId(uint smodelIndex, int lod)
{
...
void __cdecl R_AddAllStaticModelSurfacesCamera()
{
    ...
    uint* lodData; // [esp+108Ch] [ebp-80h]
    int lod; // [esp+1090h] [ebp-7Ch]
    uint smodelCount; // [esp+1094h] [ebp-78h]
    ...
    uint entryCount; // [esp+1104h] [ebp-8h]
...
void __cdecl R_AddAllStaticModelSurfacesRangeSunShadow(uint partitionIndex, uint maxDrawSurfCount)
{
    ...
    uint entryCount; // [esp+10E0h] [ebp-8h]
    uint i; // [esp+10E4h] [ebp-4h]
...
void __cdecl R_AddAllStaticModelSurfacesSpotShadow(uint spotShadowIndex, uint primaryLightIndex)
{
    double v2; // st7
    ...
    uint v18; // [esp+1048h] [ebp-70h]
    uint16_t* list; // [esp+104Ch] [ebp-6Ch]
    int lod; // [esp+1050h] [ebp-68h]
    uint i; // [esp+1054h] [ebp-64h]
    uint smodelCount; // [esp+1058h] [ebp-60h]
    ...
    uint v27; // [esp+10ACh] [ebp-Ch]
    uint v28; // [esp+10B0h] [ebp-8h]
