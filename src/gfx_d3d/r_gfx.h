...
enum GfxViewportBehavior : int
{                                       // ...
    GFX_USE_VIEWPORT_FOR_VIEW = 0x0,    // ...
    GFX_USE_VIEWPORT_FULL = 0x1,    // ...
};

enum GfxDepthRangeType : int
{                                       // ...
...
{                                       // ...
    ...
    uint skinnedCacheNormalsFrameCount; // ...
    bool fastSkin;                      // ...
    bool skinCache;                     // ...
    // padding byte
    // padding byte
...
{                                       // ...
    ...
    uint packed_low;// KISAKTODO dumb hack
};
...
{                                       // ...
    ...
    uint staticSurfaceCountNoDecal; // ...
    uint litSurfsBegin;         // ...
    uint litSurfsEnd;           // ...
