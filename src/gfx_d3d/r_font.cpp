...
const Glyph *__cdecl R_GetCharacterGlyph(Font_s *font, uint letter)
{
...
uint __cdecl R_FontGetRandomLetter(Font_s *font, int seed)
{
...
int __cdecl R_LetterWidth(uint letter, Font_s *font)
{
