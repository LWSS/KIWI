...
#endif
// CoD4Radiant filter settings â€” MFC dispatch wrappers that forward UI events
...
// The binary reaches the main frame through AfxGetApp()->m_pMainWnd â€” hex-rays renders the
...
extern void Radiant_ExecCommand( unsigned int cmdId );   // mainfrm.cpp — shell-agnostic dispatch
...
LRESULT FilterSettings_OnSelectNames()
{
    ...
    Radiant_ExecCommand( 33971 );           // View->Show->Names (CMainFrame::OnSelectNames 0x42ba40)
    return 0;
}
...
LRESULT FilterSettings_OnSelectAngles()
{
    ...
    Radiant_ExecCommand( 33972 );           // View->Show->Angles (CMainFrame::OnSelectAngles 0x42baa0)
    return 0;
}
...
LRESULT FilterSettings_OnSelectConnections()
{
    ...
    Radiant_ExecCommand( 33974 );           // View->Show->Connections (CMainFrame::OnSelectConnections 0x42bbc0)
    return 0;
}
...
LRESULT FilterSettings_OnSelectBlocks()
{
    ...
    Radiant_ExecCommand( 33973 );           // View->Show->Blocks (CMainFrame::OnSelectBlocks 0x42bb00)
    return 0;
}
...
LRESULT FilterSettings_OnSelectCoordinates()
{
    ...
    Radiant_ExecCommand( 33975 );           // View->Show->Coordinates (CMainFrame::OnSelectCoordinates 0x42bb60)
    return 0;
}
...
HWND FilterSettings_OnSelectReverseFilter()
{
    ...
    Radiant_ExecCommand( 36127 );           // View->Show->Reverse Filter (CMainFrame::OnSelectReverseFilter 0x42bc20)
    return nullptr;
}
