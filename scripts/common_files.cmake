...
set(BGAME
    ...
    "${SRC_DIR}/bgame/bg_weapon_fields.cpp"
)
...
set(DATABASE
    "${SRC_DIR}/database64/database.h"
    "${SRC_DIR}/database64/db_assetnames.cpp"
    "${SRC_DIR}/database64/db_auth.cpp"
    "${SRC_DIR}/database64/db_file_load.cpp"
    "${SRC_DIR}/database64/db_load.cpp"
    "${SRC_DIR}/database64/db_text_assets.cpp"
    "${SRC_DIR}/database64/db_font_assets.cpp"
    "${SRC_DIR}/database64/db_menu_assets.cpp"
        "${SRC_DIR}/database64/db_weapon_assets.cpp"
        "${SRC_DIR}/database64/db_impact_assets.cpp"
        "${SRC_DIR}/database64/db_external_assets.cpp"
    "${SRC_DIR}/database64/db_world_assets.cpp"
    "${SRC_DIR}/database64/db_preset_assets.cpp"
    "${SRC_DIR}/database64/db_image_assets.cpp"
    "${SRC_DIR}/database64/db_image_layout.cpp"
    "${SRC_DIR}/database64/db_shader_assets.cpp"
    "${SRC_DIR}/database64/db_shader_layout.cpp"
    "${SRC_DIR}/database64/db_technique_assets.cpp"
    "${SRC_DIR}/database64/db_material_assets.cpp"
    "${SRC_DIR}/database64/db_model_surfaces.cpp"
    "${SRC_DIR}/database64/db_model_surface_layout.cpp"
    "${SRC_DIR}/database64/db_model_assets.cpp"
    "${SRC_DIR}/database64/db_model_layout.cpp"
    "${SRC_DIR}/database64/db_physics_geometry.cpp"
    "${SRC_DIR}/database64/db_physics_geometry_layout.cpp"
    "${SRC_DIR}/database64/db_animation_assets.cpp"
    "${SRC_DIR}/database64/db_animation_layout.cpp"
    "${SRC_DIR}/database64/db_sound_assets.cpp"
    "${SRC_DIR}/database64/db_sound_layout.cpp"
    "${SRC_DIR}/database64/db_sound_aliases.cpp"
    "${SRC_DIR}/database64/db_sound_alias_layout.cpp"
    "${SRC_DIR}/database64/db_clipmap_layout.cpp"
    "${SRC_DIR}/database64/db_render_world_layout.cpp"
    "${SRC_DIR}/database64/db_render_light_grid.cpp"
    "${SRC_DIR}/database64/db_render_visibility.cpp"
    "${SRC_DIR}/database64/db_render_shadows.cpp"
    "${SRC_DIR}/database64/db_render_cells.cpp"
    "${SRC_DIR}/database64/db_render_world.cpp"
    "${SRC_DIR}/database64/db_collision_primitives.cpp"
    "${SRC_DIR}/database64/db_clipmap_assets.cpp"
    "${SRC_DIR}/database64/db_model_pieces.cpp"
    "${SRC_DIR}/database64/db_effect_layout.cpp"
    "${SRC_DIR}/database64/db_effect_trail.cpp"
    "${SRC_DIR}/database64/db_effect_references.cpp"
    "${SRC_DIR}/database64/db_effect_assets.cpp"
    "${SRC_DIR}/database64/db_memory.cpp"
    "${SRC_DIR}/database64/db_registry.cpp"
    "${SRC_DIR}/database64/db_stream.cpp"
    "${SRC_DIR}/database64/db_stream_load.cpp"
    "${SRC_DIR}/database64/db_stringtable_load.cpp"
)
if(KIWI_RAW_ONLY)
    set(DATABASE
        "${SRC_DIR}/database64/database.h"
...
set(SOUND
    ...
    "${SRC_DIR}/sound/snd_mss_files.cpp"
    "${SRC_DIR}/sound/snd_driver.cpp"
    "${SRC_DIR}/sound/snd_data.cpp"
...
set(UI
    ...
    "${SRC_DIR}/ui/ui_expression_names.cpp"
